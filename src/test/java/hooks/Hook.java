...
public class Hook {
    ...
    public void setUp() {
        ...
        System.out.println("Inicializando um novo cenário de teste...");
    ...
    private void prepararDadosParaTeste() {
        ...
        System.out.println("Dados preparados para cenário de teste...");
    }

    private void limparDadosDepoisDoTeste() {
        //Simulação de limepza de dados após o teste
