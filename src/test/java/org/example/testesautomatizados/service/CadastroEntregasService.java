package org.example.testesautomatizados.service;
...
import org.example.testesautomatizados.model.EntregaModel;
import org.example.testesautomatizados.steps.CadastroEntregaSteps;
...
public class CadastroEntregasService {
    ...
    public void setFieldsDelivery(String field, String value) {
        switch (field){
            ...
            default -> throw new IllegalArgumentException("Unexpected feld " + field);
        }
    }
    ...
    private JSONObject loadJsonFromFile (String filePath) throws IOException {
        try (InputStream inputStream = Files.newInputStream(Paths.get(filePath))) {
            JSONObject tokener = new JSONObject(new JSONTokener(inputStream));
